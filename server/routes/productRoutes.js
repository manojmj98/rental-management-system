...
router.route('/get-productbyid').post(auth, getProductById)//TODO:Should be get ideally
router.route('/get-products').post(auth, getProducts)//TODO:Should be get ideally
