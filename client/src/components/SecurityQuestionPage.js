...
const SecurityQuestionPage = props => {
        ...
        <div className="bg-black h-screen flex flex-col">
            ...
            <main className="container mx-auto flex justify-center items-center flex-grow">
                <div className="w-full max-w-md p-6 bg-gray-900 rounded-lg shadow-md">
                    <h2 className="text-2xl font-semibold text-white mb-6">Security Questions</h2>
                    <form onSubmit={submitHandler}>
                        <div className="mb-4">
                            <label htmlFor="username" className="block text-gray-300 text-sm font-medium">Question 1</label>
                            <select className="block text-gray-900 text-sm font-medium" value={q1} onChange={e => setQ1(e.target.value)}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="username" className="block text-gray-300 text-sm font-medium">Question 2</label>
                            <select className="block text-gray-900 text-sm font-medium" value={q2} onChange={e => setQ2(e.target.value)}>
                                {Object.values(SECURITY_QUESTIONS).map((question) => (
                                    <option>{question}</option>
                                ))}
                            </select>
                        ...
                        <div className="mb-4">
                            <label htmlFor="username" className="block text-gray-300 text-sm font-medium">Question 3</label>
                            <select className="block text-gray-900 text-sm font-medium" value={q3} onChange={e => setQ3(e.target.value)}>
                                {Object.values(SECURITY_QUESTIONS).map((question) => (
                                    <option>{question}</option>
                                ))}
                            </select>
